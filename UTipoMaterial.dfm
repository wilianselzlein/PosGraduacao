object FTipoMaterial: TFTipoMaterial
  Left = 202
  Top = 166
  ...
  object lbltitulo: TLabel
    ...
    Align = alTop
    Alignment = taCenter
    Caption = 'Cadastro de Tipos de Materiais'
  ...
  object RLReport: TRLReport
    ...
    object RLBand3: TRLBand
      ...
      object RLLabel1: TRLLabel
        ...
        Align = faCenter
        Alignment = taCenter
        Caption = 'Relat'#243'rio de Tipo de Material'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Height = -21
        Font.Name = 'Arial'
  ...
  object DataSource: TDataSource
    DataSet = DM.CDSTipoMaterial
    Left = 8
    Top = 8
  end
  object WSInformacao: TWSInformacao
    Tabela = 'TTIPOMATERIAL'
    Programa = 28
    Campo = 'TIPMATCOD'
    Left = 40
  end
