...
procedure TFGrupoCurso.BtnPrimeiroClick(Sender: TObject);
begin
     if DataSource.DataSet.Active then
          DataSource.DataSet.first;
end;

procedure TFGrupoCurso.BtnAnteriorClick(Sender: TObject);
begin
     if DataSource.DataSet.Active then
          DataSource.DataSet.prior;
end;

procedure TFGrupoCurso.BtnProximoClick(Sender: TObject);
begin
     if DataSource.DataSet.Active then
          DataSource.DataSet.next;
end;

procedure TFGrupoCurso.BtnUltimoClick(Sender: TObject);
begin
     if DataSource.DataSet.Active then
          DataSource.DataSet.last;
end;

procedure TFGrupoCurso.btnsairClick(Sender: TObject);
begin
     close;
end;

procedure TFGrupoCurso.BtnIncluirClick(Sender: TObject);
begin
     ...
     Editar(FGrupoCurso, true);

     DataSource.DataSet.append;
end;

procedure TFGrupoCurso.btnnovopadraoClick(Sender: TObject);
begin
     usuario((sender as TToolButton).name, wsinformacao.programa);
...
procedure TFGrupoCurso.BtnAlterarClick(Sender: TObject);
begin
     usuario((sender as TToolButton).name, wsinformacao.programa);
     ...
     begin
          PageControl.ActivePage := TabCadastro;
          Editar(FGrupoCurso, false);
          DataSource.DataSet.Edit;
     end;
end;

procedure TFGrupoCurso.BtnExcluirClick(Sender: TObject);
begin
     usuario((sender as TToolButton).name, wsinformacao.programa);
     ...
     if (DataSource.DataSet.Active = true) then
          if (DataSource.DataSet.RecordCount > 0) then
               ...
               begin
                    integridade('CURGRUPO', 'TCURSO', WSDBEdit1.text);
                    try
...
procedure TFGrupoCurso.BtnSalvarClick(Sender: TObject);
begin
...
procedure TFGrupoCurso.BtnCancelarClick(Sender: TObject);
begin
     DataSource.DataSet.Cancel;
     Navegar(FGrupoCurso);
end;

procedure TFGrupoCurso.btndesconectarClick(Sender: TObject);
begin
...
procedure TFGrupoCurso.btnexportarClick(Sender: TObject);
begin
     usuario((sender as TToolButton).name, wsinformacao.programa);
...
procedure TFGrupoCurso.btnimportarClick(Sender: TObject);
begin
     usuario((sender as TToolButton).name, wsinformacao.programa);
...
procedure TFGrupoCurso.btnhtmlClick(Sender: TObject);
begin
     usuario((sender as TToolButton).name, wsinformacao.programa);
     if not datasource.dataset.active then
          btnfiltro.click;
...
procedure TFGrupoCurso.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TFGrupoCurso.FormShow(Sender: TObject);
begin
...
procedure TFGrupoCurso.txtpesquisaKeyDown(Sender: TObject; var Key: Word;
     Shift: TShiftState);
begin
...
procedure TFGrupoCurso.btnexcelClick(Sender: TObject);
begin
     usuario((sender as TToolButton).name, wsinformacao.programa);
...
procedure TFGrupoCurso.BtnImprimirClick(Sender: TObject);
begin
     usuario((sender as TToolButton).name, wsinformacao.programa);
     rlreport.PreviewModal;
end;

procedure TFGrupoCurso.DBGridDblClick(Sender: TObject);
begin
     if btnalterar.Enabled then
          BtnAlterar.Click;
end;
...
procedure TFGrupoCurso.DBGridTitleClick(Column: TColumn);
begin
